...
@Getter
@Setter
public class SubledgerClearingEntity {
    ...
    private SubledgerEntryEntity debitEntry; // InvoiceEntity / Debit

    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "credit_entry_id", nullable = false)
    private SubledgerEntryEntity creditEntry; // Payment / Credit Memo
