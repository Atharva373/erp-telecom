...
//
//import com.atharva.erp_telecom.accounting.dto.BalanceSheetSectionRow;
...
//
//@Repository
//public interface FinancialStatementsRepository extends JpaRepository<JournalEntryLineEntity,Long> {
//
//    /**
...
//     */
//    @Query("""
//        SELECT new com.atharva.erp_telecom.accounting.dto.BalanceSheetSectionRow(
//            jel.accountCode,
//            jel.accountName,
//            jel.accountCategory,
//            SUM(
//                CASE
//                    WHEN jel.entryType = com.atharva.erp_telecom.accounting.enums.EntryType.DEBIT
//                    THEN jel.amount
//                    ELSE -jel.amount
//                END
//            )
...
//                com.atharva.erp_telecom.accounting.enums.AccountCategory.ASSET,
//                com.atharva.erp_telecom.accounting.enums.AccountCategory.LIABILITY,
//                com.atharva.erp_telecom.accounting.enums.AccountCategory.EQUITY
//            )
//            AND je.posted = true
//        GROUP BY
//            jel.accountCode,
