...
import com.atharva.erp_telecom.accounting.persistence.repository.JournalEntryRepository;
...
public class JournalEntryService {
     ...
     */
    @Transactional
    public JournalEntryEntity save(JournalEntryEntity je) {
     ...
     * Fetch one JE by ID
     */
    public JournalEntryEntity getById(Long id) {
     ...
     */
    public List<JournalEntryEntity> getBySource(Long transactionId, String transactionType) {
     ...
     */
    @Transactional
    public JournalEntryEntity reverse(Long jeId, String reversedBy) {

        JournalEntryEntity original = getById(jeId);
        ...
        for (JournalEntryLineEntity line : original.getLines()) {
            ...
            revLine.setJournalEntryEntity(reversal);
     ...
     */
    private void validateBalanced(JournalEntryEntity je) {
